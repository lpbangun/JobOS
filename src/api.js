...
export async function handleApi(s,req,res,u){
  try{
    ...
    if(req.method==='PATCH' && resource==='artifacts' && rid) return send(res,403,{type:'domain_tool_error',code:'human_review_required',error:'Artifact approval and rejection require the trusted CLI or TUI human review flow.'});

...
CREATE TABLE IF NOT EXISTS resume_source_imports (resume_id TEXT PRIMARY KEY, source_format TEXT NOT NULL DEFAULT 'text', source_name TEXT NOT NULL DEFAULT '', source_archive_path TEXT NOT NULL DEFAULT '', extraction_json TEXT NOT NULL DEFAULT '{}', FOREIGN KEY(resume_id) REFERENCES profile_resume_revisions(id));

...
| W05 | Contact confidence, outreach relevance, and outcomes | P1 | `PLANNING` | `fix/contact-outreach` | Existing research/outreach contracts | Review and lock `W05_CONTACT_OUTREACH_IMPLEMENTATION_PLAN.md`, then execute independent Wave A chunks |

...
| W04 | Fit consistency, legitimacy boundary, and calibration | P0 | `IN_PROGRESS` | `fix/fit-consistency` | W03 `jobos.posting-liveness.v1` integrated; W06 `jobos.fit-outcome-aggregates.v1` remains calibration-only gate | Execute immediate score-consistency and W03-boundary Chunks 0–5; defer only W06 calibration Chunk 6 |
